...
async def help_command(_, message: Message):
    if message.chat.type != "private":
        ...
        return await message.reply("ᴘᴍ ᴍᴇ ғᴏʀ ʜᴇʟᴘ...", reply_markup=kb)
    kb = ikb(
        {
            "𝐇𝐞𝐥𝐩": "bot_commands",
            "𝐔𝐩𝐝𝐚𝐭𝐞𝐬": "https://t.me/HeroOfficialBots",
            "𝐀𝐝𝐝 𝐌𝐞 𝐓𝐨 𝐘𝐨𝐮𝐫 𝐆𝐫𝐨𝐮𝐩": f"https://t.me/{BOT_USERNAME}?startgroup=new",
            "𝐒𝐮𝐩𝐩𝐨𝐫𝐭 𝐂𝐡𝐚𝐭": "https://t.me/Yaaro_ki_yaarii",
        }
    )
    mention = message.from_user.mention
    await message.reply_photo(
        "https://te.legra.ph/file/72b8500b85d0c4798c6d5.jpg",
        caption=f"ʜɪ {mention}, ɪ'ᴍ sᴘᴀᴍ ᴘʀᴏᴛᴇᴄᴛɪᴏɴ ʀᴏʙᴏᴛ,"
        + " ᴄʜᴏᴏsᴇ ᴀɴ ᴏᴘᴛɪᴏɴ ғʀᴏᴍ ʙᴇʟᴏᴡ...",
        reply_markup=kb,
    )
...
async def help_parser(name, keyboard=None):
    ...
    return (
        f"ʜᴇʟʟᴏ {name}, ɪ'ᴍ sᴘᴀᴍ ᴘʀᴏᴛᴇᴄᴛɪᴏɴ ʀᴏʙᴏᴛ, ɪ ᴄᴀɴ ᴘʀᴏᴛᴇᴄᴛ "
        + "ʏᴏᴜʀ ɢʀᴏᴜᴘ ғʀᴏᴍ sᴘᴀᴍ ᴀɴᴅ ɴsғᴡ ᴍᴇᴅɪᴀ ᴜsɪɴɢ "
        + "ᴍᴀᴄʜɪɴᴇ ʟᴇᴀʀɴɪɴɢ. ᴄʜᴏᴏsᴇ ᴀɴ ᴏᴘᴛɪᴏɴ ғʀᴏᴍ ʙᴇʟᴏᴡ...",
        keyboard,
    )
...
async def help_button(client, query: CallbackQuery):
    ...
    top_text = (
        f"ʜᴇʟʟᴏ {u}, ɪ'ᴍ sᴘᴀᴍ ᴘʀᴏᴛᴇᴄᴛɪᴏɴ ʀᴏʙᴏᴛ, ɪ ᴄᴀɴ ᴘʀᴏᴛᴇᴄᴛ "
        + "ʏᴏᴜʀ ɢʀᴏᴜᴘ ғʀᴏᴍ sᴘᴀᴍ ᴀɴᴅ ɴsғᴡ ᴍᴇᴅɪᴀ ᴜsɪɴɢ "
        + "ᴍᴀᴄʜɪɴᴇ ʟᴇᴀʀɴɪɴɢ. ᴄʜᴏᴏsᴇ ᴀɴ ᴏᴘᴛɪᴏɴ ғʀᴏᴍ ʙᴇʟᴏᴡ..."
    )
    if mod_match:
...
async def runs_func(_, message: Message):
    await message.reply("ɪ ᴀᴍ ʀᴜɴɴɪɴɢ....")
